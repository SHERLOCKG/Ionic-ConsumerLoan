...
export class ResultPage {
  ...
  private beaAppUrl: any;
  private confirmMobile: string;
  private showMobile: string;
  constructor(
    ...
    public snitizer: DomSanitizer
  ) { }
  ionViewDidLoad() {
    this.confirmMobile = customConfig.confirmMobile;
    this.showMobile = customConfig.showMobile;
    ...
    this.beaAppUrl = this.snitizer.bypassSecurityTrustResourceUrl(this.beaAppUrl);
  }
